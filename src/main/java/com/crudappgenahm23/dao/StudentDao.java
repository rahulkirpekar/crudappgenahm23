...
import com.crudappgenahm23.util.DBConnection;

// PreparedStatement
public class StudentDao
{
//	private static final Logger log = Logger.getLogger(StudentDaoPrep.class);
...
//			log.info("StudentDaoPrep --insertStudent()---Db not connected");
		}
		return rowsAffected;
	}
